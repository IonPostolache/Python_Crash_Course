...
#gogup=Admin(privileges3)
#gogup=Privileges(privileges3)
#gogup.show_privileges()
admin_instance=Admin(privileges3)
admin_instance.__init__(privileges3)

...
class Battery():
    ...
    def upgrade_battery(self):
        """Check the current battery size."""
        print(f"The current battery size is set to {self.battery_size}.")
        """Set it to 100."""
        self.battery_size=100
        print(f"The battery size after set is {self.battery_size}.")
...
my_tesla.battery2.get_range()
my_tesla.battery2.upgrade_battery()
my_tesla.battery2.get_range()
